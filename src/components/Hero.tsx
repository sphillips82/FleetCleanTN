      ...
      <nav className="relative z-10 container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold">FleetClean<span className="text-blue-400">TN</span></span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="tel:+1234567890" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 px-6 py-2.5 rounded-lg transition-colors font-medium">
